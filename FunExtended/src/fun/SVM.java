...
public class SVM {
	...
	public static final byte        // opcodes
	   LOADG   =  0,  STOREG  =  1,
	   LOADL   =  2,  STOREL  =  3,
	   LOADC   =  4,  LOADR   =  5, //EXTENSION
	   ADD     =  6,  SUB     =  7,
	   MUL     =  8,  DIV     =  9,
	   CMPEQ   = 10,  COMPG   =  11, //EXTENSION
	   CMPLT   = 12,  CMPGT   = 13,
	   INV     = 14,  INC     = 15,
	   HALT    = 16,  JUMP    = 17,
	   JUMPF   = 18,  JUMPT   = 19,
	   CALL    = 20,  RETURN  = 21,
	   COPYARG = 22,  COPY    = 23; //EXTENSION

	private static final String[] mnemonic = {
	   "LOADG   ",    "STOREG  ",
	   "LOADL   ",    "STOREL  ",
	   "LOADC   ",    "LOADR     ", //EXTENSION
	   "ADD     ",    "SUB     ",
	   "MUL     ",    "DIV     ",
	   "CMPEQ   ",    "COMPG     ", //EXTENSION
	   "CMPLT   ",    "CMPGT   ",
	   "INV     ",    "INC     ",
	   "HALT    ",    "JUMP    ",
	   "JUMPF   ",    "JUMPT   ",
	   "CALL    ",    "RETURN  ",
	   "COPYARG ",    "COPY "};		//EXTENSION
	...
	// as it is executed.
		...
		do {
			...
			switch (opcode) {
				...
				//EXTENSION
				case COPY: { // copy previous word to stack
					int a = data[sp-1];
					data[sp++] = a;
					break;
				}
				case COMPG: { // compare the guard
					int g = data[--sp];
					int exp = data[sp-1];
					if(g==e)
					{
